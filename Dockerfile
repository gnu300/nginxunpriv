...
# gnu300: adds python packages and other useful debugging packages
...
# gnu300: nginx user must own the cache directory to write cache
RUN chown -R 1001:0 /var/cache/nginx \
    && chmod -R g+w /var/cache/nginx

# gnu300: forward request and error logs to docker log collector
